...
public class Copyright extends AppCompatActivity {
    ...
    /* TextView de las declaraciones de Copyright. */
    TextView textViewCopyrightLicenciaIconosVerDeclaracion;
    TextView textViewCopyrightLicenciaMPAndroidChartVerDeclaracion;
    TextView textViewCopyrightLicenciaVolleyVerDeclaracion;

    /*
     * Diálogos de alerta de las
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* TextView de las declaraciones de Copyright. */
        textViewCopyrightLicenciaIconosVerDeclaracion =
                findViewById(R.id.textViewCopyrightLicenciaIconosVerDeclaracion);
        textViewCopyrightLicenciaMPAndroidChartVerDeclaracion =
                findViewById(R.id.textViewCopyrightLicenciaMPAndroidChartVerDeclaracion);
        textViewCopyrightLicenciaVolleyVerDeclaracion =
                findViewById(R.id.textViewCopyrightLicenciaVolleyVerDeclaracion);

        /* Diálogos de la declaración del Copyright. */
        textViewCopyrightLicenciaIconosVerDeclaracion.setOnClickListener(view -> {
            alertDialogBuilder = new AlertDialog.Builder(Copyright.this);
            View viewAlertDialog = getLayoutInflater().inflate(R.layout.view_copyright, null);
        ...
        textViewCopyrightLicenciaMPAndroidChartVerDeclaracion.setOnClickListener(view -> {
            alertDialogBuilder = new AlertDialog.Builder(Copyright.this);
            View viewAlertDialog = getLayoutInflater().inflate(R.layout.view_copyright, null);
            alertDialogBuilder.setPositiveButton("Close",
                    (dialogInterface, i) -> dialogInterface.dismiss());
        ...
        textViewCopyrightLicenciaVolleyVerDeclaracion.setOnClickListener(view -> {
            alertDialogBuilder = new AlertDialog.Builder(Copyright.this);
            View viewAlertDialog = getLayoutInflater().inflate(R.layout.view_copyright, null);
            alertDialogBuilder.setPositiveButton("Close",
                    (dialogInterface, i) -> dialogInterface.dismiss());
